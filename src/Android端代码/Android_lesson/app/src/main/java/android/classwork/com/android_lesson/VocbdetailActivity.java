...
public class VocbdetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vocbdetail);

        Intent intent = getIntent();
        English = intent.getStringExtra("English");

        tv_English = (TextView) findViewById(R.id.detail_English);
        tv_Chinese = (TextView) findViewById(R.id.detail_Chinese);
        tv_vocbRoot = (TextView) findViewById(R.id.detail_vocbRoot);
        tv_sentence = (TextView) findViewById(R.id.detail_sentence);
        tv_sentenceChinese = (TextView) findViewById(R.id.detail_sentenceChinese);
        tv_Need = (TextView) findViewById(R.id.detail_Need);
        img_vocb = (ImageView) findViewById(R.id.detail_vocbImg);
